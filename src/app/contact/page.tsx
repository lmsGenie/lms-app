...
const page = () => {
  ...
  const handleEmailCopy = () => {
    copyToClipboard(contactDetails?.email)
      .then(() => {
        if (copied) {
          toast({
  ...
  return (
    <main>
      ...
      <section className="flex flex-col-reverse items-center gap-3 border-b-[1px] border-gray-500 py-5 dark:border-gray-800 sm:flex-row sm:px-10 sm:py-0 sm:pt-2 xl:gap-20 xl:px-48 xl:pt-10">
      ...
      <section className="flex flex-col items-center gap-2 bg-gray-50 py-5 dark:bg-gray-800 sm:px-10 md:gap-10 md:py-10 xl:px-48">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-[40%_auto] md:gap-5 lg:gap-10">
          ...
          {/* contact form */}
          <section className="space-y-5 bg-white p-2 sm:p-5 lg:p-10">
            {/* form header */}
